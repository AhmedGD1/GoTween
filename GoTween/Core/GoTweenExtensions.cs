...
{
    public static PropertyBuilder GoProperty(this GodotObject @object, string property)
    {
        return GoTween.GetPool<PropertyBuilder>(@object, property);
    }

    public static Tween GoProperty(this GodotObject @object, string property, Action<PropertyBuilder> config)
    {
        var builder = GoTween.GetPool<PropertyBuilder>(@object, property);
        config(builder);
    ...
    public static void GoKillAll(this GodotObject @object)
    {
